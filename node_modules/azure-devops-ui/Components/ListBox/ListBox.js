            ...
            return (React.createElement(Observer, { key: item.id || index, item: item }, function () { return (React.createElement(TableRow, { key: item.id || index, index: index, details: rowDetails, className: css("bolt-list-box-row", item.type === ListBoxItemType.Header && "bolt-list-box-header-row", item.type === ListBoxItemType.Divider && "bolt-list-box-divider-row", item.type === ListBoxItemType.Loading && "bolt-list-box-loading-row", _this.multiSelect && "bolt-list-box-multi-select-row", item.type !== ListBoxItemType.Header && item.type !== ListBoxItemType.Divider && "cursor-pointer", item.disabled && "bolt-list-box-item-disabled") }, _this.columns.map(function (tableColumn, columnIndex) {
                if (_this.multiSelect && columnIndex === 0) {
                    if (item.type === ListBoxItemType.Divider || item.type === ListBoxItemType.Loading) {
                        ...
                        return document.body.classList.contains('dropdown-list-component-enabled') ? (React.createElement("span", { className: "bolt-table-cell bolt-list-cell bolt-header-cell", "data-column-index": "0", role: "presentation" })) : renderEmptyCell(index, columnIndex);
                    }
                }
                if (document.body.classList.contains('dropdown-list-component-enabled')) {
        ...
        if (!_this.props.columns) {
            ...
            if (_this.multiSelect && _this.props.showChecksColumn !== false) {
                ...
                _this.columns.push({
                    id: "column-check",
                    width: 24,
                    renderCell: function (rowIndex, columnIndex) { return (document.body.classList.contains('dropdown-list-component-enabled') ? (React.createElement("div", { className: "dropdown-list checkmark-icon", "data-column-index": columnIndex, key: "column-check", role: "presentation" },
                        React.createElement(Icon, { ariaHidden: "removed", className: css(!_this.selection.selected(rowIndex) && "invisible"), iconName: "CheckMark" }))) : (React.createElement(SimpleTableCell, { columnIndex: columnIndex, key: "column-check", role: "presentation" },
...
export function renderListBoxCell(rowIndex, columnIndex, tableColumn, tableItem, multiSelect) {
    ...
    return (React.createElement(SimpleTableCell, { className: css(tableColumn.className, tableItem.className, tableItem.type === ListBoxItemType.Header && "bolt-list-box-header"), columnIndex: columnIndex, key: tableItem.id, role: "presentation", tableColumn: tableColumn },
        React.createElement("div", { id: tableItem.type === ListBoxItemType.Header ? "header-".concat(tableItem.groupId) : undefined, "aria-label": tableItem.type === ListBoxItemType.Header && !document.body.classList.contains('dropdown-list-component-enabled') ? format(Resources.HeaderAriaLabel, tableItem.text) : undefined, className: "bolt-list-box-cell-container" }, tableItem && renderListCell(tableItem, false))));
}
