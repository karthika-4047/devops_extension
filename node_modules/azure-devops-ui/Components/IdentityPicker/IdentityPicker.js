    ...
    function IdentityPicker(props) {
        ...
        _this.renderSuggestionItem = function (suggestion) {
            return (React.createElement("div", { className: "flex-row flex-grow full-width", onKeyDown: _this.onKeyDownSuggestionItem },
                React.createElement(IdentityPickerSuggestionItem, __assign({}, suggestion, { onOpenPersonaCard: _this.onOpenPersonaCard, ref: function (itemRef) { return (_this.itemRefs[suggestion.item.entityId] = itemRef); }, renderSuggestion: _this.props.renderCustomIdentitySuggestion && _this.renderCustomSuggestionItem, imageUrlResolver: _this.props.imageUrlResolver }))));
        };
            ...
            return !!_this.props.convertItemToPill && person.entityType === IdentityType.Custom
                ...
                : {
                    ...
                    onRenderFilledVisual: isUnresolvedEmail
                        ? undefined
                        : function () {
                            return React.createElement(Persona, { ariaLabel: "", className: "flex-row flex-center", identity: person, size: PersonaSize.size20, imageUrlResolver: _this.props.imageUrlResolver });
                        }
                };
        };
