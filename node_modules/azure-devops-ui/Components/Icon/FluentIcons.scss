@font-face {
    ...
    src: url("./fonts/fluent-filled-v1.1.201.woff2") format("woff2");
}

@font-face {
    font-family: "FluentRegular";
    src: url("./fonts/fluent-regular-v1.1.201.woff2") format("woff2");
}
    ...
    */
    ...
    .ms-Icon--Fingerprint {
        ...
        &:before {
            font-family: "FluentRegular";
            content: "\E611";
            // Needs 16px, added in a later version
        }
    }
