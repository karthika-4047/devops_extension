...
import { IImageUrlResolver } from '../../Image';
 ...
 */
export declare const renderSuggestionItem: (suggestion: IIdentitySuggestionItemProps, onOpenPersonaCard?: (identity: IIdentity) => void, renderCustomIdentitySuggestion?: (identity: IIdentity) => JSX.Element, imageUrlResolver?: IImageUrlResolver) => JSX.Element;
