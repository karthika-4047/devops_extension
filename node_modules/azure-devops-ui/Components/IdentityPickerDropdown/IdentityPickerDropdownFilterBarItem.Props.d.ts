...
export interface IIdentityPickerDropdownFilterBarItemProps extends IFilterBarItemProps, Pick<IIdentityPickerProps, "pickerProvider" | "imageUrlResolver">, Pick<ISharedIdentityPickerProps, "className" | "editPlaceholder" | "resolveUnrecognizedIdentity"> {
    /**
