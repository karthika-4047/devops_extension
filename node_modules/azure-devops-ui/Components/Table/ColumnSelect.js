...
var ColumnSelect = /** @class */ (function () {
    function ColumnSelect(props) {
        ...
        this.renderCell = function (rowIndex, columnIndex, listColumn) {
            ...
            return (document.body.classList.contains('dropdown-list-component-enabled') && _this.isListbox ? (React.createElement("div", { "aria-hidden": _this.ariaHidden, className: css("bolt-table-cell-select bolt-table-cell bolt-list-cell flex-noshrink", "col-" + columnIndex), "data-column-index": columnIndex, key: "col-select", onClick: preventDefault, onDoubleClick: preventDefault, onMouseDown: function (event) {
